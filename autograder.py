...
# Le but est de vérifier si ton implémentation se comporte exactement comme prévu pour les algorithmes de recherche, de Q-learning, de planification, etc.
# Tu ne soumets donc pas ton code à un correcteur humain, mais à une machine qui :
# • exécute ton code,
# • le compare à des résultats attendus,
# • te donne une note automatique (et parfois une explication des erreurs).
